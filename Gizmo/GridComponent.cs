...
namespace XNA3DGizmoExample
{
    public sealed class GridComponent
    {
        ...
        private Color _highlightColorY = Color.DarkOliveGreen;
        private Color _highlightColorX = Color.Red;
        private Color _highlightColorZ = Color.Blue;
        ...
        public void ResetLines()
        {
            ...
            // add highlights
            vertexList.Add(new VertexPositionColor(Vector3.Forward * gridSize, _highlightColorZ));
            vertexList.Add(new VertexPositionColor(Vector3.Backward * gridSize, _highlightColorZ));

            vertexList.Add(new VertexPositionColor(Vector3.Right * gridSize, _highlightColorX));
            vertexList.Add(new VertexPositionColor(Vector3.Left * gridSize, _highlightColorX));

            vertexList.Add(new VertexPositionColor(Vector3.Up * gridSize, _highlightColorY ));
            vertexList.Add(new VertexPositionColor(Vector3.Down * gridSize, _highlightColorY));
